    ...
    return (
        <>
            ...
            <div style={{display : 'flex', justifyContent : 'center', alignItems : 'center', flexWrap : 'wrap', height : '95vh', width : '100%'}}>
                ...
                <div className="button" onClick={()=>{history.push('/shapes')}}>Shape</div>
                <div className="button" onClick={()=>{history.push('/owl')}}>Owl</div>
                <div className="button" onClick={()=>{history.push('/circular-menu')}}>Menu</div>
            </div>
